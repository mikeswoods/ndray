...
stillLife1 :: IO (Scene (WorldObject Primitive))
stillLife1 =
  return $ scene $ do
...
stillLife2 :: IO (Scene (WorldObject Primitive))
stillLife2 = do
...
space1 :: IO (Scene (WorldObject Primitive))
space1 = do 
